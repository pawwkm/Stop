...
namespace Topz.ArmV6Z.Operands
{
    ...
    internal sealed class LogicalLeftShiftByRegisterOperand : AddressingMode1
    {
        ...
        /// <param name="rs">The register that the <paramref name="rm"/> is being left shifted by.</param>
        /// <exception cref="ArgumentNullException">
        /// <paramref name="rm"/> or <paramref name="rs"/> is null.
        /// </exception>
        public LogicalLeftShiftByRegisterOperand(Register rm, Register rs)
        {
            if (rm == null)
        ...
        {
            return $"{Rm}{Symbols.Comma} {Register.Lsl} {Rs}";
        }
    }
}