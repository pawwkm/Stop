...
namespace Topz.ArmV6Z
{
    ...
    internal abstract class Pass : IPass
    {
        ...
        /// <paramref name="instruction"/> is null.
        /// </exception>
        public virtual void Visit(BranchAndChangeToJazelleInstruction instruction)
        {
            if (instruction == null)
                throw new ArgumentNullException(nameof(instruction));
        }
        ...
        /// <paramref name="instruction"/> is null.
        /// </exception>
        public virtual void Visit(CountLeadingZeroesInstruction instruction)
        {
            if (instruction == null)
                throw new ArgumentNullException(nameof(instruction));
        }
        ...
        /// <paramref name="instruction"/> is null.
        /// </exception>
        public virtual void Visit(CompareInstruction instruction)
        {
            if (instruction == null)
                throw new ArgumentNullException(nameof(instruction));
        }
